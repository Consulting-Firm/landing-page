...
export const PROJECTS: Project[] = [
  ...
  {
    name: "SNPC — Postal Union Site",
    tags: ["Next.js 16", "Payload CMS v3", "PostgreSQL", "Cloudflare R2", "Docker + Caddy"],
    description:
  ...
  {
    name: "Spotlite — Geospatial Mapping",
    tags: ["Azure Container Apps", "TiTiler / FastAPI", "Python (GDAL)", "MapLibre + deck.gl"],
    description:
    ...
    imageAlt: "Spotlite geospatial map viewer showing LiDAR layers over Portugal",
    imageW: 2668,
    imageH: 1305,
  },
  {
    name: "CuriaSelf — Legislative Data Platform",
    tags: ["Docker Compose", "Traefik", "Keycloak", "PostgreSQL", "GitHub Actions"],
    description:
  ...
  {
    name: "Netop — Deployment Controller",
  ...
  {
    name: "BLNG — Real-Time Collaboration Backend",
    tags: ["TypeScript", "Yjs (CRDT)", "AWS Fargate / DynamoDB", "SST v3 + Pulumi", "Redis"],
    description:
  ...
  {
    name: "Rudig Consultores — BESSMO",
    tags: ["FastAPI", "AWS ECS Fargate", "Terraform", "Amazon SQS", "PostgreSQL"],
    description:
  ...
  {
    name: "Nine International — BI & ESG Platform",
