...
export const TEAM: TeamMember[] = [
  ...
  },
  {
    ...
    photo: "/catalin.jpg",
    name: "Catalin",
    role: "Backend Engineer · AI & LLM Expertise",
    bio: "Software engineer at Adobe building the agent-orchestration and LLM platform — integrating Claude Bedrock and Azure OpenAI models, prototyping AI governance, and operating microservices across AWS and Azure Kubernetes. Backend-leaning full-stack engineer who ships RAG pipelines, REST services, and CI/CD end to end.",
...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    description:
      "Software Engineer on the agent-orchestration platform. Integrated and evaluated four AWS Claude Bedrock model configurations against the Azure OpenAI baseline through LiteLLM on the OpenAI Agents SDK, prototyped pre-inference AI governance with Bedrock Guardrails and Azure AI Content Safety, and built a Jenkins PR regression pipeline that provisions ephemeral environments and runs the full agent suite. Operated microservices across AWS and Azure Kubernetes with Argo CD, Helm, and Prometheus/Grafana.",
    people: ["Catalin"],
    role: "Software Engineer",
    timeframe: { start: "Jan 2025", end: "Present" },
    background: "#8fd0c4",
    image: "/work-agent-orchestrator.png",
    imageAlt: "Adobe agent-orchestration platform interface",
    imageW: 2708,
    imageH: 1740,
  },
  {
    ...
    description:
      "Software Engineer Intern re-architecting the document ingestion system from a single synchronous app into a three-stage asynchronous Kafka pipeline — ingestion → chunking → embedding — for reliable large-file handling and independent scaling. Built REST APIs to ingest and index PDF, Markdown, and plaintext with tenant isolation, a cloud-agnostic storage handler routing to Azure Blob/File or AWS S3, and ran comparative POCs of Pinecone, Milvus, and pgvector for embedding storage.",
    people: ["Catalin"],
    role: "Software Engineer Intern",
    timeframe: { start: "Jul 2024", end: "Dec 2024" },
    background: "#f4d58a",
    image: "/work-ingestion.png",
    imageAlt: "Document ingestion platform pipeline",
    imageW: 1920,
    imageH: 1031,
  },
  {
    ...
    description:
      "Online platform for coding-interview prep where users solve problems with help from an AI chatbot over text or voice, write code in their language of choice, and get instant feedback scored on tests passed. Tiered Stripe subscriptions unlock additional features. Java and Spring Boot services behind a Vue.js + Tailwind front end, with Express.js, Firebase, and the OpenAI API.",
    people: ["Catalin"],
    role: "Full-Stack Developer",
    timeframe: { start: "Oct 2023", end: "Jun 2024" },
    background: "#b8d98e",
    image: "/work-ddoc.png",
    imageAlt: "Daily Dose of Code interview-prep platform",
    imageW: 3456,
    imageH: 1924,
  },
  {
    ...
    description:
      "Software Engineer across two client platforms — Roomio, where the team enhanced the product to meet client requirements and broaden its appeal to future clients, and Trax, migrating a legacy application onto a new framework and building new features in close collaboration with the client.",
    people: ["Catalin"],
    role: "Software Engineer",
    timeframe: { start: "Oct 2022", end: "Apr 2024" },
    background: "#f0b6c2",
    image: "/work-roomio.png",
    imageAlt: "Roomio property-management platform",
    imageW: 3456,
    imageH: 1924,
  },
  {
    ...
    description:
      "Software Engineer Intern designing and building a web application that accurately estimates the effort required to construct IT projects from a given set of requirements.",
    people: ["Catalin"],
    role: "Software Engineer Intern",
    timeframe: { start: "Jul 2022", end: "Oct 2022" },
    background: "#bcd0ef",
    image: "/work-trax.png",
    imageAlt: "Trax application interface",
    imageW: 3456,
    imageH: 1924,
  },
  {
